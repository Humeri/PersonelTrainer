...
def findAngle(img, p1, p2, p3, lmList, draw = True):  #p1 p2 p3 3 noktadır. bu üç noktanın açısı hesaplanacak
    
    x1, y1 = lmList[p1][1:]  #noktaların x y koordinatları 1'den başlayıp sona kadar gider
    x2, y2 = lmList[p2][1:] 
    x3, y3 = lmList[p3][1:] 
...
while True:
    ...
    lmList = []
    if results.pose_landmarks:  #eğer sonuçlar varsa eklemleri çizdirme komutları
    ...
    if len(lmList) != 0:  #lmlist boş değilse yani bir detect var ise
